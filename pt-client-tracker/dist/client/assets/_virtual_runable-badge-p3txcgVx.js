...
`,C=r=>r==="light"?"light":"dark",w=()=>{var r;return typeof window>"u"?"dark":C((r=window.__RUNABLE_CONFIG__)==null?void 0:r.theme)},E=()=>{if(typeof document>"u"||document.getElementById(h))return;const r=document.createElement("style");r.id=h,r.textContent=x,document.head.appendChild(r)},L=r=>{if(typeof document>"u")return;const t=document.getElementById(n);t&&(t.dataset.theme=r)},c=document.createElement("div");c.id=n;document.body.appendChild(c);E();L(w());y.createRoot(c).render(e.jsx(v,{}));
